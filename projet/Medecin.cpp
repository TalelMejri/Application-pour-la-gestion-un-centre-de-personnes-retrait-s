...
Medecin::Medecin(int idVal, string nomVal, string prenomVal, string emailVal, string adresseVal, string telVal, string sexeVal, DATE dateNaissanceVal, double salaireVal, string specialiteVal)
